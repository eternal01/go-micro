...
create index mining_right_idx_auditor_id
    on mining_right (auditor_id);

create index mining_right_idx_title
    on mining_right (title);

create index mining_right_idx_user_id
    on mining_right (user_id);
